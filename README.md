...
- **Colab5 — Continued Pretraining (Mistral 7B v0.3)**
  - Notebook: 'Colab5'
  - Open in Colab: https://colab.research.google.com/drive/13MdmkU55k-IlUujEGoHYNSc0XT3ieH7N?usp=sharing

🎥 **YouTube walkthrough:** https://youtu.be/2lM6PsLvOwc

---

## 🗺️ Repository files navigation
...
2. In Colab: **Runtime → Change runtime type → GPU (T4/A100 if available)**.
...
- Make sure to respect each model’s license and terms.
